...
const EditModal = ({ id, title, description, category, pimage }) => {
  const [image, setimage] = useState(pimage || false);
  ...
  return (
    <>
      <form
        onSubmit={onSubmithd}
        className="pt-5 px-5 sm:pt-12 sm:pl-16 z-10 backdrop-blur-lg"
      >
