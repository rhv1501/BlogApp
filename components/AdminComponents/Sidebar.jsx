...
const Sidebar = () => {
  return (
    <>
      <div className="flex-col bg-slate-100 hidden md:flex">
        ...
        <div className="w-28 sm:w-80 h-[100vh] relative py-12 border border-black">
          <div className="w-[50%] sm:w-[80%] absolute right-0">
            ...
            >
              <Image src={assets.add_icon} alt="add btn" width={28} />
              <p>add Blogs</p>
            </Link>
            <Link
              href={"/admin/blogList"}
            ...
            >
              <Image src={assets.blog_icon} alt="add btn" width={28} />
              <p>Blog List</p>
            </Link>
            <Link
              ...
              className="mt-5 flex items-center border border-black gap-3 font-medium px-3 py-2 bg-white shadow-[-5px_5px_0px_#000]"
            >
              <Image src={assets.email_icon} alt="add btn" width={28} />
              <p>Subscriptions</p>
            </Link>
          </div>
        </div>
